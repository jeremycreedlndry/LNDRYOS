...
import { Plus, Pencil, Trash2, Check, X, WashingMachine, Wind, RefreshCw } from 'lucide-react'
...
function MachineSection({ type, label, icon: Icon, description }: typeof SECTIONS[0]) {
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Set up washers and dryers to track where each order is being processed</p>
        </div>
        <Button
          variant="outline"
          size="sm"
